...
export function downloadInvoiceTemplate() {
  ...
  const headers = [
    ...
    'client_name', 'client_address', 'client_gstin', 'legal_name', 'hsn_sac',
  ...
  const sample = [
    ...
    ['invoice', 'pune', 'DSLM/26-27/099', '05/05/2026', 'SAMPLE CLIENT LLP', 'Floor 1, Sample Street, Pune, Maharashtra, 411001', '27ABCDE1234F1Z5', '', '997331', 'CRM Application', 'Set-Up Fee', '04/05/2026', '10', 'Current', 'cgst_sgst', '25000', '2250', '2250', '0', '29500', 'UPI', 'paid', '', ''],
    ['invoice', 'bengaluru', 'DSLK/26-27/037', '06/05/2026', 'BENGALURU SAMPLE PVT LTD', '#123, HSR Layout, Bengaluru, Karnataka, 560102', '29ABCDE1234F1Z5', 'Bengaluru Sample Private Limited', '997331', 'CRM Application', 'Renewal', '06/05/2026', '20', '1 Year', 'igst', '76271.19', '0', '0', '13728.81', '90000', 'NEFT', 'due', '94080', '06/08/2026'],
    ...
    ['NOTE', '', '', '', '', '', '', '', '', '', 'amount_due: only used when status=due (outstanding amount owed). Leave empty for paid invoices.', '', '', '', '', '', '', '', '', '', '', '', '']
  ];
...
export function downloadDubaiTemplate() {
  ...
  const sample = [
    headers,
    ['invoice', 'dubai', 'DSL/26-27/DB-041', '18/02/2026', 'S K R LEASING PROPERTY BROKERAGE AGENTS L.L.C', 'OFFICE 803, OXFORD TOWER, BUSINESS BAY, DUBAI, UAE', '104479933400001', '', 'Leadrat CRM Software', 'New', '18/02/2026', '10', '6 Months', '2095.24', '104.76', '2200', 'Bank Transfer', 'paid', '', ''],
    ['invoice', 'dubai', 'DSL/26-27/DB-041', '18/02/2026', 'S K R LEASING PROPERTY BROKERAGE AGENTS L.L.C', 'OFFICE 803, OXFORD TOWER, BUSINESS BAY, DUBAI, UAE', '104479933400001', '', 'Leadrat CRM Software', 'Set-Up Fee', '18/02/2026', '10', 'Current', '500', '25', '525', 'Bank Transfer', 'paid', '', ''],
    ...
    ['NOTE', '', '', '', '', '', '', '', '', '', '', 'amount_due: only used when status=due. legal_name: optional — leave blank unless explicitly different from client_name.', '', '', '', '', '', '', '', '']
  ];
  const ws = XLSX.utils.aoa_to_sheet(sample);
  ws['!freeze'] = { xSplit: 0, ySplit: 1 };
...
export function downloadClientTemplate() {
  ...
  ws['!cols'] = [{ wch: 28 }, { wch: 32 }, { wch: 50 }, { wch: 18 }, { wch: 20 }];
  const wb = XLSX.utils.book_new();
